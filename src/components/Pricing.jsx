        ...
        <div className="container">
          <div className="flex-row items-center justify-center w-full">
            <div className="flex justify-center !mt-2">
              <h1 className="text-[3rem]">Pricing</h1>
            </div>
            <div className="cards w-full !mt-5 flex flex-wrap justify-center items-center gap-4">
              <div className="card1 w-[310px] h-[400px] border border-[#4949498c] rounded-lg ">
                <div className="w-full flex-row !px-6 !py-5 ">
                  ...
                  <div className="flex items-center justify-center">
                    <button className="border border-[#9c2e0370] linkBg transition !px-20 !py-[7px] rounded-sm !mt-14 text-[16px] text-[#b9b9b9] cursor-pointer">
                      Subscribe
                    </button>
                  </div>
                </div>
              ...
              <div className="card2 w-[310px] h-[400px] border border-[#4949498c] rounded-lg ">
                <div className="w-full flex-row !px-6 !py-5 ">
              ...
              <div className="card3 w-[310px] h-[400px] border border-[#4949498c] rounded-lg ">
                <div className="w-full flex-row !px-6 !py-5 ">

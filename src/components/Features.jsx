    ...
    <>
      <div className="w-full flex-col items-center">
        <div className="container">
          <div className="item1 bg-[#131313] flex justify-center w-fit !mx-auto">
          ...
          <div className="item3 flex flex-wrap items-center justify-center !mt-10 gap-4 ">
            <div className=" flex-row w-[300px] h-[200px] gap-3">
              ...
              <p className="text-[12px] flex items-center justify-center !ml-4 !mt-5">
            ...
            <div className=" flex-row w-[300px] h-[200px] gap-3 ">
              ...
              <p className="text-[12px] flex items-center justify-center !mt-5">
            ...
            <div className=" flex-row w-[300px] h-[200px] gap-3">
              ...
              <p className="text-[12px] flex items-center !ml-9 !mt-5 ">
